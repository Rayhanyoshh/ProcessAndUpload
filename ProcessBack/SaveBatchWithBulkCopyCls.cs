    ...
    public class SaveBatchWithBulkCopyCls : R_IBatchProcess
    {
        public void R_BatchProcess(R_BatchProcessPar poBatchProcessPar)
        {
            ...
            try
            {
                ...
                lcCmd = "select SeqNo=0,*,ErrorMsg = convert(varchar(1000),'') into #raw_data from dbo.EmployeeTable where 0=1";
                ...
                loDb.R_BulkInsert<EmployeeDTO>((System.Data.SqlClient.SqlConnection)loConn, "#raw_data", loObject, loMapping);
